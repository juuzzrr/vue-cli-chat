...
<div class="chat-window" id="ChatWindow">
    ...
    <div class="chat-send-panel">
      <input type="text" placeholder="Ваш никнейм..." class="chat-send-name-field" v-model="usernameGet">
      <input type="text" placeholder="Сообщение..." class="chat-send-message-field" v-model="textGet"/>
